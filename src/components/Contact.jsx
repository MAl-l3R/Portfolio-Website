...
// EmailJS IDs
// Template ID: template_8kv8wkt
// Service ID: service_p70t7pk 
// Public ID: WKTKrPRquHd8FiIi8
  ...
  return (
    <div className='xl:mt-12 xl:flex-row flex-col flex gap-10 overflow-hidden'>
      <motion.div
        ...
        className='flex-[0.67] bg-black-100 p-8 rounded-2xl'
      >
